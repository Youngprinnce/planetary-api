...
app.config['MAIL_USERNAME'] = '1d29e9c1dc976d'
app.config['MAIL_PASSWORD'] = 'cde207bfc6f736'
...
def parameters():
    ...
    if age < 18:
        ...
        return jsonify({"message":'Welcome {}, you are old enough'.format(name)}), 200
...
def retrieve_password(email: str):
    ...
    if user:
        ...
        mail.send(msg)
        return jsonify({"message": "Password sent to {}".format(email)})
    else:
